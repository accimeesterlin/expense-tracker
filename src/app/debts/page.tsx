        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-[#476788]">Total Debt</p>
          ...
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-[#476788]">Active Debts</p>
                <p className="text-2xl font-bold text-[#0B3558]">
          ...
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-[#476788]">Total Debts</p>
                <p className="text-2xl font-bold text-[#0B3558]">{debts.length}</p>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-[#476788]">
                      ...
                      {debt.interestRate && (
                        <div>
                          ...
                          <span className="text-[#0B3558]">{debt.interestRate}%</span>
                        </div>
                      )}
                      {debt.minimumPayment && (
                        <div>
